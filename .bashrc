...
#shortcuts to change background
GREENB_REDT=$'\[\033[42m\]\[\033[31m\]'
REDB_GREENT=$'\[\033[41m\]\[\033[32m\]'
NOB_REDT=$'\[\033[31m\]'
RESET=$'\[\033[00m\]'
TRIANGLE=$'\uE0B0'
GIT_BRANCH_NAME='$(__git_ps1 "%s")'

#disable default Python (.venv) in PS1, I'm adding it manually.
...
export DJANGO_SUPERUSER_PASSWORD='asdf'
export DJANGO_SUPERUSER_USERNAME='chris'
export DJANGO_SUPERUSER_EMAIL='christopher.jones@apsva.us'
export PGPASSWORD='NewPassword'
export PSQL_PAGER='less -S'
export KANATA_TRAY_LOG_DIR='/home/work/.config/kanata-tray/'
